...
Kapcsolódó leírások: [kézikönyv forrása](../repl-help-hu.md), [Claude beállítása](../claude-repl-guide-hu.md), [Claude-munkautasítás](../claude-repl-instructions.md), [protokoll](../../PROTOCOL.md). A tranzakciós működés alapja a [Spring programozott tranzakciókezelése](https://docs.spring.io/spring-framework/reference/data-access/transaction/programmatic.html) és [propagációs szemantikája](https://docs.spring.io/spring-framework/reference/data-access/transaction/declarative/tx-propagation.html).

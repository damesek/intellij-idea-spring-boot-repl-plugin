...
public final class ReplProtocol {
    ...
    public static final Set<String> CONTROL_OPS = Set.of("notifications/poll", "clone", "describe", "interrupt", "close", "capture/arm", "capture/status", "capture/disarm", "capture/list", "events/start", "events/stop", "events/list", "events/clear", "trace/history", "trace/call", "trace/stop");
    public static final Set<String> OPS = Set.of("notifications/poll", "clone", "describe", "close", "interrupt", "eval", "java-eval", "analyze",
            ...
            "trace/case-info", "trace/case-create", "snapshot/edit-read", "snapshot/edit-validate", "snapshot/edit-copy", "case/variants",
            "beans/list", "beans/info", "beans/prepare", "beans/compatible-data", "watch/add", "watch/list", "watch/get", "watch/remove", "watch/refresh", "case/affected");

...
4. **Start MCP > Copy client config**, majd frissítsd a kliens URL-jét/tokenjét és eszközlistáját. Minden MCP-indítás új tokent generál. A pontos Claude-beállítás a [kapcsolódási útmutatóban](docs/claude-repl-guide-hu.md) található.
...
- [Claude-kapcsolódás és példák](docs/claude-repl-guide-hu.md)
- [Önálló agentutasítás és a teljes 60 eszköz referenciája](docs/claude-repl-instructions.md)
